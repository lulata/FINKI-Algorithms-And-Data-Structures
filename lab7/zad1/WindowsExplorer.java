...
public class WindowsExplorer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        windowsExploerer(tree, commands);
    }

    public static void windowsExploerer(SLLTree<String> tree, String[] input) {
        ...
        for (int i = 0; i < input.length; i++) {
            ...
            switch (command) {
                ...
                case "DELETE": {
                    SLLNode<String> delete = current.firstChild;
                    if (delete != null && delete.element.equals(node)) {
                        delete.parent.firstChild = delete.sibling;
                        break;
                    }
                    while (delete.sibling != null) {
                        if (delete.sibling.element.equals(node)) {
