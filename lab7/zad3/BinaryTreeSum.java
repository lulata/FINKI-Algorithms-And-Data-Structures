...
class BTree<E extends Comparable<E>> {
    ...
    public BNode<E> find(BNode<E> temp,E elem) {
        ...
        if (temp.info.compareTo(elem) == 0){
            return temp;
        }

        BNode<E> tmp = find(temp.left, elem);

        if (tmp != null){
            return tmp;
        }

        return find(temp.right, elem);
    }
...
public class BinaryTreeSum {
    ...
    private static BTree<Integer> tree;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print(tree.sumLeft(tmp.left,tmp) + " " + tree.sumRight(tmp.right,tmp));
    }
}
